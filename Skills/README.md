...
* **Related skills** — pole `related_skills` rekordu `SKILL-*`,
* **Development Areas** — pole `sources.skills` w rekordach `DEV-*`,
...
| `SKILL-018` | Persuasive Communication | `ACH-P005` — Wieloletni wolontariat kaznodziejski — komunikacja perswazyjna w tere… | `SKILL-013` — Public Speaking<br>`SKILL-011` — Stakeholder Management<br>`SKILL-017` — Cross-Functional Facilitation | — |
| `SKILL-019` | Business Analysis & Requirements Engineering | `ACH-016` — Zunifikowanie architektury ekosystemu aplikacji i zarządzanie wymagan…<br>`ACH-005` — Zaprojektowanie i wdrożenie systemu gwarancyjnego<br>`ACH-011` — Stworzenie systemu kalkulacji komponentów dla działu handlowego<br>`ACH-015` — Wdrożenie systemu paszportyzacji produktów i kodyfikacji numerów sery…<br>`ACH-019` — Architektura procesu życia produktu - projekt modelu operacyjnego fir… | — | `DEV-007` — Asymmetric Self-Valuation |
| `SKILL-020` | AI Tooling & Automation | `ACH-015` — Wdrożenie systemu paszportyzacji produktów i kodyfikacji numerów sery…<br>`ACH-P006` — VaultShot CV — zaprojektowanie i wdrożenie systemu generowania aplika… | — | — |
| `SKILL-021` | Systems Thinking | `ACH-002` — Samodzielne opanowanie platformy Bitrix24 - od zera do projektanta au…<br>`ACH-003` — Stworzenie bazy wiedzy serwisowej BPMN 2.0<br>`ACH-010` — Projektowanie organizacji na podstawie analizy danych operacyjnych<br>`ACH-016` — Zunifikowanie architektury ekosystemu aplikacji i zarządzanie wymagan…<br>`ACH-P004` — Projektowanie systemów organizacyjnych, baz wiedzy i narzędzi informa…<br>`ACH-P006` — VaultShot CV — zaprojektowanie i wdrożenie systemu generowania aplika… | `SKILL-001` — Process Design<br>`SKILL-008` — Business Systems<br>`SKILL-015` — Organizational Design<br>`SKILL-016` — Operational Analysis<br>`SKILL-019` — Business Analysis & Requirements Engineering | `DEV-003` — Delegation and Leverage |
...
* **Achievements (dowody):**
  ...
  - `ACH-P006` — VaultShot CV — zaprojektowanie i wdrożenie systemu generowania aplikacji dopasowanych pod ofertę (r…
* **Related skills:**
  - `SKILL-001` — Process Design
...
* **Achievements (dowody):**
  ...
  - `ACH-020` — Zbudowanie i prowadzenie procesów rekrutacyjnych dla ról technicznych
  - `ACH-P001` — Regularne prowadzenie wystąpień publicznych i koordynacja społeczności
  - `ACH-P005` — Wieloletni wolontariat kaznodziejski — komunikacja perswazyjna w terenie i rezyliencja psychologicz…
* **Related skills:**
  - `SKILL-003` — Knowledge Management
  - `SKILL-006` — Technical Documentation
...
## Kompetencje bez dowodu

_Brak — każda kompetencja wskazuje co najmniej jeden Achievement._

## Kompetencje bez słów kluczowych

Brak `keywords` oznacza, że dopasowanie do oferty opiera się wyłącznie na nazwie:

_Brak — każda kompetencja ma słowa kluczowe._

## Autoreferencje w `related_skills`

Kompetencja wskazująca samą siebie — wpis bez znaczenia informacyjnego, pomijany w listach powyżej:
