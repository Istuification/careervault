...
Predyktor opisuje preferencję zrozumienia istniejących systemów przed ich zmianą.

Optymalizacja jest naturalną konsekwencją tego mechanizmu, ale nie stanowi jego głównego celu.
...
2. Zrozum dlaczego działa.
3. Oceń jego ograniczenia.
4. Oceń koszt zmiany.
5. Optymalizuj tylko wtedy, gdy korzyść uzasadnia koszt.
...
CAL-002 dodatkowo doprecyzowuje, że Predictor opisuje sposób podejścia do istniejących systemów i procesów, a nie mechanizmy związane z ochroną przepustowości, zarządzaniem obciążeniem lub wyznaczaniem granic operacyjnych.
