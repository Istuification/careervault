...
System poznawczy badanego opiera się na ciągłym modelowaniu i strukturyzowaniu rzeczywistości organizacyjnej (PRED-006). Rdzeniem operacyjnym jest dekonstrukcja chaosu informacyjnego i przekształcanie go w logiczne systemy wiedzy oraz procesy (ACH-003, STORY-005). Układ ten aktywuje się optymalnie w środowiskach o wysokim poziomie wieloznaczności lub długu organizacyjnego (STORY-001). Głównym kosztem ubocznym całego systemu jest skłonność do internalizacji odpowiedzialności (DEV-002, DEV-006), co prowadzi do przeciążenia własnej przepustowości operacyjnej oraz tendencji do unikania wczesnych konfrontacji interpersonalnych w imię harmonii (DEV-001, DEV-005).
